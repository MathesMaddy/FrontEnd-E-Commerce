...
const LoginPage = () => {
    ...
    useEffect( () => {
        const FetchUserDetail = async() => {
            try{
                let fetchedData = await fetch('userdetail.json')
    ...
    const CheckUserDetail = (e) => {
        ...
        if(userDetail.username == email && userDetail.password == password) {
            ...
            localStorage.setItem('user-authentication',JSON.stringify(userDetail.username))
    ...
    <div>
        <div style={{display: "flex", height: '100vh'}}>
            <div style={{backgroundColor: 'aquamarine', width: '100%'}}>
                <img src="pexels-jan-van-der-wolf-11680885-12379905.jpg" alt="" width={'100%'} height={'100%'} style={{objectFit: 'cover'}} />
            </div>

            <div style={{ width: '100%', display: "flex", justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap', backgroundColor: "white" }}>
                <div>
                    <div style={{}}>
                        ...
                        <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '5px'}}>
                            ...
                            <img src="android-chrome-512x512.png" alt="" width={'50px'}/>
                            <div>

                                <h1 style={{margin: '0', fontWeight:'300', fontSize:'1.5rem', marginTop: '-6px'}}>Quick Cart</h1>
                            </div>

                        </div>

                        <h2 style={{textAlign: 'center',margin: '5px 0px 20px 10px', fontWeight: "400"}}>Welcome Back</h2>
                    </div>
                    
                    <form className="form_container" onSubmit={CheckUserDetail}>
                        ...
                        <input placeholder="name@mail.com" title="Inpit title" name="username" type="text" className="input_field" id="email_field" />
                        </div>
                        <div className="input_container">
